// Script to add 50 products to each store
const fs = require('fs');

// Read your stores data (paste it here or load from file)
const storesData = JSON.parse(process.argv[2]);
...
// Output the result
console.log(JSON.stringify(updatedStores));
