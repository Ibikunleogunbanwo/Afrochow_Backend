-- ===========================================================================
-- Afrochow Database Migration V41
-- Description: Re-run the Quebec showroom Calgary clone under a new Flyway version.
--
-- V39 created a small standalone Quebec sample set, and V40 may already be recorded in some environments. The Calgary production
-- showroom is the flow we trust, so this migration safely re-copies the existing Calgary
