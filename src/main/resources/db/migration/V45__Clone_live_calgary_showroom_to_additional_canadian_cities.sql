-- ===========================================================================
-- Afrochow Database Migration V45
-- Description: Clone the live Calgary showroom flow to additional Canadian cities.
--
...
--
-- Target cities:
--   Edmonton AB, Regina SK, Ottawa ON, Victoria BC.
--
-- Safety:
...
('ABEDM', 'Edmonton', 'AB', 'America/Edmonton',  'T5J0N3', '780880', 'Showroom Edmonton', 53.5461, -113.4938),
('SKREG', 'Regina',   'SK', 'America/Regina',    'S4P3Y2', '306881', 'Showroom Regina',   50.4452, -104.6189),
('ONOTT', 'Ottawa',   'ON', 'America/Toronto',   'K1P1J1', '613880', 'Showroom Ottawa',   45.4215, -75.6972),
('BCVIC', 'Victoria', 'BC', 'America/Vancouver', 'V8W1P6', '250880', 'Showroom Victoria', 48.4284, -123.3656);
