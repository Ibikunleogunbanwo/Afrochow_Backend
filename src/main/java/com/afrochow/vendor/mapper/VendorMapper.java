package com.afrochow.vendor.mapper;
...
public class VendorMapper {
    ...
    public VendorProfileResponseDto toResponseDto(VendorProfile profile) {
        ...
        return VendorProfileResponseDto.builder()
                ...
                .stripeChargesEnabled(profile.getStripeChargesEnabled())
                .stripePayoutsEnabled(profile.getStripePayoutsEnabled())
                .payoutReady(profile.isPayoutReady())
                .stripeRequirementsDisabledReason(profile.getStripeRequirementsDisabledReason())
