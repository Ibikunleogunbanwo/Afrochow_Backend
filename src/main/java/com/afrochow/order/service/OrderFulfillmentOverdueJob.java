 ...
 *   - {@link FulfillmentSafetyNetJob} only protects OUT_FOR_DELIVERY/READY_FOR_PICKUP
 ...
 *
 * Two-pass design, same pattern as FulfillmentSafetyNetJob:
 *
 * Pass 1 — Flag:
...
@Slf4j
@Service
public class OrderFulfillmentOverdueJob {
    ...
    public OrderFulfillmentOverdueJob(
    ...
    @SchedulerLock(
            name           = "OrderFulfillmentOverdueJob",
            lockAtMostFor  = "PT5M",
            lockAtLeastFor = "PT1M"
    )
