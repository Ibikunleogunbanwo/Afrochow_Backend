package com.afrochow.email.service;
...
public class EmailService {
    ...
    public void sendOrderConfirmationEmail(
        ...
        try {
            ...
            context.setVariable("appName", appName);
            context.setVariable("appUrl", appUrl);
            context.setVariable("orderTrackingUrl", String.format("%s/order-confirmation/%s", appUrl, orderPublicId));
    ...
    public void sendPaymentConfirmationEmail(
        ...
        try {
            ...
            context.setVariable("appName", appName);
            context.setVariable("appUrl", appUrl);
            context.setVariable("orderViewUrl", String.format("%s/order-confirmation/%s", appUrl, orderPublicId));
